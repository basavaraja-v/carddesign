...
const BusinessCard: React.FC<BusinessCardProps> = ({ data, html }) => {
    ...
    return (
        <div className="relative">
            ...
            <button
                className="absolute top-2 right-6 bg-blue-500 text-white px-2 py-1 rounded-md shadow hover:bg-blue-600"
                onClick={handleDownload}
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path d="M0 0h24v24H0z" fill="none" />
                    <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z" fill="#FFFFFF" />
                </svg>
            </button>
        </div>
    );
